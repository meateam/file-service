...
const shortcutSchema: mongoose.Schema = new mongoose.Schema(
  {
    name: {
      type: String,
      required: true,
...
const shortcutModel: mongoose.Model<mongoose.Document & IShortcut> = BaseFileModel.discriminator(shortcutModelName, shortcutSchema);
