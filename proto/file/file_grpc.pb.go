...
type FileServiceClient interface {
	...
	GetFilesByIDs(ctx context.Context, in *GetByFilesByIDsRequest, opts ...grpc.CallOption) (*GetFilesByIDsResponse, error)
...
func (c *fileServiceClient) GetFilesByIDs(ctx context.Context, in *GetByFilesByIDsRequest, opts ...grpc.CallOption) (*GetFilesByIDsResponse, error) {
	out := new(GetFilesByIDsResponse)
	err := c.cc.Invoke(ctx, "/file.FileService/GetFilesByIDs", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type FileServiceServer interface {
	...
	GetFilesByIDs(context.Context, *GetByFilesByIDsRequest) (*GetFilesByIDsResponse, error)
...
func (UnimplementedFileServiceServer) GetFilesByIDs(context.Context, *GetByFilesByIDsRequest) (*GetFilesByIDsResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetFilesByIDs not implemented")
}
...
func _FileService_GetFilesByIDs_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/file.FileService/GetFilesByIDs",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(FileServiceServer).GetFilesByIDs(ctx, req.(*GetByFilesByIDsRequest))
	}
	return interceptor(ctx, in, info, handler)
}
